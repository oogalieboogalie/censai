...
export const DEFAULT_THEME = { hue: 145, chroma: 0.11, lightness: 0.62, mood: 'cream', customVars: {}, gridSnapping: true, groupSnapping: true, canvasPanMode: 'both', borderWidth: 1, fontScale: 1.0 };
